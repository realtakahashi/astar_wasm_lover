...
import ABI from '../../artifacts/astar_wasm_lover.json';
import QueryMethods from '../query/astar_wasm_lover';
import BuildExtrinsicMethods from '../build-extrinsic/astar_wasm_lover';
import TxSignAndSendMethods from '../tx-sign-and-send/astar_wasm_lover';
import MixedMethods from '../mixed-methods/astar_wasm_lover';
import EventsClass from '../events/astar_wasm_lover';
